...
export const SettingsIcon = ({ className, style }: IconSvgProps) => (
...
export const DataRefreshIcon = ({ className, style }: IconSvgProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" height="18" viewBox="0 0 18 18" width="18" className={className} style={style}>
    <ellipse className="icon-fill" cx="9" cy="3.5" rx="8" ry="2.5" />
    <path className="icon-fill" d="M7.4,15.1V13.45a4.80943,4.80943,0,0,1,.058-.55,6.53769,6.53769,0,0,1,.1855-.812C5.1165,11.923,1.75,11.322,1,10.135V14.5c0,1.2095,2.75,2.218,6.4,2.45Z" />
    <path className="icon-fill" d="M13.5,7.4a6.05744,6.05744,0,0,1,3.15.925l.2075-.212L17,7.967V5.135c-1.2235,1.5475-5.532,2-8,2s-7.106-.584-8-2V8.5c0,1.28,3.079,2.3335,7.047,2.4805A6.08649,6.08649,0,0,1,13.5,7.4Z" />
    <path className="icon-fill" d="M13.5,16.7175a3.106,3.106,0,0,1-2.3855-1.0615l1.154-1.156H9v3.275l1.25-1.2545A4.372,4.372,0,0,0,13.5,18,4.65,4.65,0,0,0,18,13.5H16.86A3.4445,3.4445,0,0,1,13.5,16.7175Z" />
    <path className="icon-fill" d="M16.779,10.479A4.60747,4.60747,0,0,0,13.5,9,4.65,4.65,0,0,0,9,13.5h1.14a3.4445,3.4445,0,0,1,3.36-3.2175,3.1415,3.1415,0,0,1,2.4355,1.058L14.8,12.5H18V9.2325Z" />
  </svg>
);
